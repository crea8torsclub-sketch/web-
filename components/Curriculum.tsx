      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {modules.map((mod, idx) => (
            <div
              key={idx}
              className="hairline-border relative rounded-lg bg-brand-panel/60 p-8 flex flex-col justify-between group cursor-default"
            >
              ...
              <div>
                {/* Module Number */}
                <span className="font-mono text-xs font-semibold text-brand-cyan uppercase tracking-wider block mb-4">
                  Module {mod.num}
                </span>
